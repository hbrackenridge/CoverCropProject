...
model.mort<- lmer(Mort ~ Cult * SR * Time + (1 | Year/Rep) + (1 | Location/Rep) + (1 | Year:Location:Rep), data=mortdatlong)
summary(model.mort)
anova(model.mort)
...
# means
mortemmeans<- emmeans(model.mort.best, pairwise ~ Cult*Time)
mortemmeans
plot(mortemmeans, comparisons=T)
```
*Best Model:*
Mort ~ Cult + Time + (1 | Year/Rep) + (1 | Location/Rep) + (1 | Year:Location:Rep) + Cult:Time

*Effects:*
          Sum Sq Mean Sq NumDF  DenDF F value    Pr(>F)    
Cult       31376   31376     1 692.35 111.247 < 2.2e-16 ***
Time      225066   75022     3 680.15 266.000 < 2.2e-16 ***
Cult:Time  15089    5030     3 680.15  17.834 3.757e-11 ***

*Assumptions:*
Okay

*Means:*
 Cult     Time       emmean   SE   df lower.CL upper.CL
 Early    Mort_14DAT   74.3 7.43 3.76    53.14     95.5
 Standard Mort_14DAT   49.6 7.40 3.69    28.39     70.8
 Early    Mort_21DAT   81.7 7.43 3.76    60.52    102.8
 Standard Mort_21DAT   67.9 7.40 3.69    46.67     89.1
 Early    Mort_28DAT   83.9 7.43 3.76    62.77    105.1
 Standard Mort_28DAT   84.6 7.40 3.69    63.41    105.9
 Early    Mort_7DAT    45.4 7.43 3.76    24.23     66.5
 Standard Mort_7DAT    28.8 7.40 3.69     7.53     50.0

*Comparisons:*
 contrast                                  estimate   SE  df t.ratio p.value
 Early Mort_14DAT - Standard Mort_14DAT      24.678 2.53 684   9.762 <.0001 *
 Early Mort_14DAT - Early Mort_21DAT         -7.381 2.59 681  -2.848 0.0852 
 Early Mort_14DAT - Standard Mort_21DAT       6.397 2.53 684   2.531 0.1843 
 Early Mort_14DAT - Early Mort_28DAT         -9.631 2.59 681  -3.717 0.0053 *
 Early Mort_14DAT - Standard Mort_28DAT     -10.342 2.53 684  -4.091 0.0012 *
 Early Mort_14DAT - Early Mort_7DAT          28.905 2.59 681  11.154 <.0001 *
 Early Mort_14DAT - Standard Mort_7DAT       45.543 2.53 684  18.016 <.0001 *
 Standard Mort_14DAT - Early Mort_21DAT     -32.059 2.53 684 -12.682 <.0001 *
 Standard Mort_14DAT - Standard Mort_21DAT  -18.281 2.42 681  -7.542 <.0001 *
 Standard Mort_14DAT - Early Mort_28DAT     -34.309 2.53 684 -13.572 <.0001 *
 Standard Mort_14DAT - Standard Mort_28DAT  -35.021 2.42 681 -14.448 <.0001 *
 Standard Mort_14DAT - Early Mort_7DAT        4.226 2.53 684   1.672 0.7056 
 Standard Mort_14DAT - Standard Mort_7DAT    20.865 2.42 681   8.608 <.0001 *
 Early Mort_21DAT - Standard Mort_21DAT      13.778 2.53 684   5.450 <.0001 *
 Early Mort_21DAT - Early Mort_28DAT         -2.250 2.59 681  -0.868 0.9887 
 Early Mort_21DAT - Standard Mort_28DAT      -2.961 2.53 684  -1.172 0.9398 
 Early Mort_21DAT - Early Mort_7DAT          36.286 2.59 681  14.003 <.0001 *
 Early Mort_21DAT - Standard Mort_7DAT       52.924 2.53 684  20.936 <.0001 *
 Standard Mort_21DAT - Early Mort_28DAT     -16.028 2.53 684  -6.341 <.0001 *
 Standard Mort_21DAT - Standard Mort_28DAT  -16.740 2.42 681  -6.906 <.0001 *
 Standard Mort_21DAT - Early Mort_7DAT       22.508 2.53 684   8.904 <.0001 *
 Standard Mort_21DAT - Standard Mort_7DAT    39.146 2.42 681  16.149 <.0001 *
 Early Mort_28DAT - Standard Mort_28DAT      -0.711 2.53 684  -0.281 1.0000 
 Early Mort_28DAT - Early Mort_7DAT          38.536 2.59 681  14.871 <.0001 *
 Early Mort_28DAT - Standard Mort_7DAT       55.174 2.53 684  21.826 <.0001 *
 Standard Mort_28DAT - Early Mort_7DAT       39.247 2.53 684  15.526 <.0001 *
 Standard Mort_28DAT - Standard Mort_7DAT    55.885 2.42 681  23.055 <.0001 *
 Early Mort_7DAT - Standard Mort_7DAT        16.638 2.53 684   6.582 <.0001 *

### Pop ups
```{r rye pop up data manipulation}
# use WF data too?? was it sprayed after all mortality data collected?
popdat<- datwtrt[,c(1:10, 39, 42, 45, 48)]
popdatlong<- gather(popdat, Time, Pop, Pop_7DAT:Pop_28DAT)
str(popdatlong)
popdatlong$Pop<- as.integer(popdatlong$Pop)
```
...
```{r rye popup models}
model.pop<- glmer(Pop ~ Cult * SR * Time + (1 | Year/Rep) + (1 | Location/Rep) + (1 | Year:Location:Rep), data=popdatlong, family=poisson(link="log"))
summary(model.pop)
anova(model.pop)

model.pop.best<- stepcAIC(model.pop) # won't converge
...
```
*Best Model:*
Pop ~ Cult + Time + (1 | Year/Rep) + (1 | Location/Rep) + (1 | Year:Location:Rep) + Cult:Time

*Effects:*
          Sum Sq Mean Sq NumDF  DenDF F value    Pr(>F)    
Cult       14823 14822.8     1 695.42  30.645 4.394e-08 ***
Time       23168  7722.7     3 681.45  15.966 4.841e-10 ***
Cult:Time  57726 19242.0     3 681.45  39.781 < 2.2e-16 ***
...
# test effect of rye
model.stand<- glmer(Corn_stand ~ Trt_code + (1 | Year / Rep) + (1 | Location / Rep), data=datw, family=poisson(link="log"))
summary(model.stand)
anova(model.stand)

model.stand.best<- stepcAIC(model.stand)
# best model is original, above

# check residuals
resid.model.stand<- resid(model.stand)
pred.model.stand<- predict(model.stand)
...
standemmeans<- emmeans(model.stand, pairwise ~ Trt_code, type="response")
standemmeans
...
# test effect of trts
model.standtrt<- glmer(Corn_stand ~ Cult * SR + (1 | Year / Rep) + (1 | Location / Rep), data=datwtrt, family=poisson(link="log"))
summary(model.standtrt)
anova(model.standtrt)

model.standtrt.best<- stepcAIC(model.standtrt)
...
model.standw<- glmer(Corn_stand ~ Weediness * Cult * SR + (1 | Year / Rep), data=Hdatw, family=poisson(link="log"))
summary(model.standw)
anova(model.standw)

model.standw.best<- stepcAIC(model.standw)
...
model.standw600<- glmer(Corn_stand ~ Weediness * Cult + (1 | Year / Rep) + (1 | Location / Rep), data=datw1, family=poisson(link="log"))
summary(model.standw600)
anova(model.standw600)

model.standw600.best<- stepcAIC(model.standw600)
...
model.standws<- glmer(Corn_stand ~ Weediness + (1 | Year / Rep) + (1 | Location / Rep), data=datw2, family=poisson(link="log"))
summary(model.standws)
anova(model.standws)

model.standws.best<- stepcAIC(model.standws)
...
# test effect of trts
model.standwf<- glmer(Corn_stand ~ Trt_code + (1 | Year / Rep), data=Hdatwf, family=poisson(link="log"))
summary(model.standwf)
anova(model.standwf)

model.standwf.best<- stepcAIC(model.standwf)
...
# glmer
model.weedcount<- glmer(Count ~ Cult * SR * Time + (1 | Year / Rep) + (1 | Location / Rep) + (1 | Year:Location:Plot), data=wdat, family=poisson)
Anova(model.weedcount2, type="III")

# lmer
model.weedcount2<- lmer(Count ~ Cult * SR * Time + (1 | Year / Rep) + (1 | Location / Rep) + (1 | Year:Location:Plot), data=wdat)
...
# check residuals
resid.model.wcount2<- resid(model.weedcount2)
pred.model.wcount2<- predict(model.weedcount2)

# check randomness
plot(pred.model.wcount2, resid.model.wcount2, ylab="Residuals", xlab="Weed counts", main="Predictecd vs Residuals")
# weird trend

# check normality
hist(resid.model.wcount2, main="Histogram of Residuals", xlab="weed counts")
# long tails on right

qqnorm(resid.model.wcount2) # curvy shape

# Shapiro-Wilk test
shapiro.test(resid.model.wcount2)
# assumptions not met, needs transformations? Or not using right format of data?

# both glmer & lmer assumptions bad

# try glmer w/ transformations
model.weedcount3<- glmer(Count ~ Cult * SR * Time + (1 | Year / Rep) + (1 | Location / Rep) + (1 | Year:Location:Plot), data=wdat, family=poisson(link="log"))
Anova(model.weedcount2, type="III")

# check residuals
resid.model.wcount3<- resid(model.weedcount3)
pred.model.wcount3<- predict(model.weedcount3)

# check randomness
plot(pred.model.wcount3, resid.model.wcount3, ylab="Residuals", xlab="Weed counts", main="Predictecd vs Residuals")
# weird trend

# check normality
hist(resid.model.wcount3, main="Histogram of Residuals", xlab="weed counts")
# long tails on right

qqnorm(resid.model.wcount3) # curvy shape

# Shapiro-Wilk test
shapiro.test(resid.model.wcount3)
# assumptions not met, needs transformations? Or not using right format of data?
```
...
# total
model.stand<- lmer((Rye_front_stand+Rye_back_stand) ~ Trt_plnt + (1 | Year/Rep) + (1 | Location/Rep), data=dirtrt)
summary(model.stand)
anova(model.stand)
...
model.pop<- lmer(popups ~ Trt_plnt*Trt_crmp*time + (1 | Year/Rep) + (1 | Location/Rep) + (1 | Year:Location:Plot), data=dirpop)
summary(model.pop)
anova(model.pop)

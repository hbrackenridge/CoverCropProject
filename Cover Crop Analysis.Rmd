...
# test effect of trts
model.htwf<- lmer(Corn_ht_av ~ Trt_code + (1 | Year / Rep) + (1 | Location / Rep), data=Hdatwf)
summary(model.htwf)
anova(model.htwf)
...
# test effect of trts
model.Mwf<- lmer(M_count ~ Trt_code + (1 | Year / Rep) + (1 | Location / Rep), data=Hdatwf)
summary(model.Mwf)
anova(model.Mwf)
...
# test effect of trts
model.UMwftrt<- lmer(UM_count ~ Cult * SR + (1 | Year / Rep) + (1 | Location / Rep), data=Hdatwftrt)
...
# lmer
model.weedcount<- lmer(Count ~ Cult * SR * Location * Time + (1 | Rep : Year) + (1 | Plot), data=wdat)
summary(model.weedcount)
Anova(model.weedcount, type="III")

# glmer
model.weedcount2<- glmer(Count ~ Cult * SR * Location * Time + (1 | Rep : Year) + (1 | Plot), data=wdat, family=poisson)

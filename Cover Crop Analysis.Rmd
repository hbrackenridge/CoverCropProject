...
model.ryewt<- lmer(Rye_wt ~ Cult * SR * Location + ( 1 | Rep:Year), data=datwtrt)
summary(model.ryewt)
anova(model.ryewt)
...
model.till<- lmer(TAv ~ Cult * SR * Location + ( 1 | Rep:Year), data=datwtrt)
summary(model.till)
anova(model.till)
...
# model analysis for rye stem diameter
model.anth<- lmer(anthesis ~ Cult * Location + ( 1 | Rep:Year), data=datwtrt)
summary(model.anth)
anova(model.anth)

...
datwf2<- subset(datwf, Weediness=="WF") # datwf2 contains only wf trts

dat<- subset(dat, Trt_num<9) # remove WF rye trts

datr<- subset(dat, Cult!="NA") # datr contains only trt plots

Sdatw<- subset(datwf, Year!="2019"&Location=="StJean")
Sdatw<- subset(Sdatw, Trt_num==4 | Trt_num==7 | Trt_num==11 | Trt_num==14) # contains only StJean data w/ W/WF factor
Sdatw1<- subset(Sdatw, Year=="2020") # contains both cultivars
Sdatw2<- subset(Sdatw, Year=="2021") # contains Std only

Hdatw<- subset(datwf, Location=="Harrow"&Year!="2019") # contains only Harrow data w/ W/WF factor
Hdatw<- subset(Hdatw, Trt_num!=1 & Trt_num!=8)
Hdatw1<- subset(Hdatw, SR=="600")

datw<- rbind(Hdatw1, Sdatw1) # contains both Harrow & StJean data w/ W/WF factor for S & E @ 600

Hdatwf<- subset(datwf2, Location=="Harrow"&Year!="2019")
Hdatwf1<- subset(Hdatwf, SR=="600")
Sdatwf<- subset(datwf2, Year!="2019"&Location=="StJean")
Sdatwf1<- subset(Sdatwf, Year=="2020") # contains both cultivars
Sdatwf2<- subset(Sdatwf, Year=="2021") # contains Std only

HSdatwf<- rbind(Hdatwf1, Sdatwf1) # contains both Harrow & StJean for both cult @ 600 
...
model.standw600<- lmer(Corn_stand ~ Weediness * Cult * Location + ( 1 | Rep:Year), data=datw)
...
model.standws<- lmer(Corn_stand ~ Weediness + ( 1 | Rep:Year), data=Sdatw2)
...
# test effect of trts
model.standwf600<- lmer(Corn_stand ~ Trt_code * Location + ( 1 | Rep:Year), data=HSdatwf)
...
standwf600emmeans
plot(standwf600emmeans, comparisons=T) # Std & Early > NR

standwf600emmeans1<- emmeans(model.standwf600.best, pairwise ~ Location)
standwf600emmeans1
plot(standwf600emmeans1, comparisons=T) # Harrow > StJean
```

```{r corn stand analysis -- wf trts, S 600}
# test effect of trts
model.standwfs<- lmer(Corn_stand ~ Trt_code + ( 1 | Rep:Year), data=Sdatwf)
...
```{r corn stand analysis -- w vs wf trts, E & S 600}
# test effect of w/wf trt -> Harrow & StJean E & S, 600
model.htw600<- lmer(Corn_ht_av ~ Weediness * Cult * Location + ( 1 | Rep:Year), data=datw)
...
```{r corn stand analysis -- w vs wf trts, S 600}
# test effect of w/wf trt -> StJean S, 600
model.htws<- lmer(Corn_ht_av ~ Weediness + ( 1 | Rep:Year), data=Sdatw2)
summary(model.htws)
anova(model.htws)
...
```{r corn stand analysis -- w vs wf trts, E & S 600}
# test effect of w/wf trt -> Harrow & StJean E & S, 600
model.Mw600<- lmer(M_count ~ Weediness * Cult * Location + ( 1 | Rep:Year), data=datw)
summary(model.Mw600)
anova(model.Mw600)
...
```{r corn stand analysis -- w vs wf trts, S 600}
# test effect of w/wf trt -> StJean S, 600
model.Mws<- lmer(M_count ~ Weediness + ( 1 | Rep:Year), data=Sdatw2)
summary(model.Mws)
anova(model.Mws)
...
# test effect of w/wf trt -> Harrow & StJean E & S, 600
model.Mwtw600<- lmer(M_wt ~ Weediness * Cult * Location + ( 1 | Rep:Year), data=datw)
...
# test effect of w/wf trt -> StJean S, 600
model.Mwtws<- lmer(M_wt ~ Weediness + ( 1 | Rep:Year), data=Sdatw2)
summary(model.Mwtws)
anova(model.Mwtws)
...
# test effect of w/wf trt -> Harrow & StJean E & S, 600
model.UMw600<- lmer(UM_count ~ Weediness * Cult * Location + ( 1 | Rep:Year), data=datw)
...
# test effect of w/wf trt -> StJean S, 600
model.UMws<- lmer(UM_count ~ Weediness + ( 1 | Rep:Year), data=Sdatw2)
summary(model.UMws)
anova(model.UMws)
...
# test effect of w/wf trt -> Harrow & StJean E & S, 600
model.UMwtw600<- lmer(UM_wt ~ Weediness * Cult * Location + ( 1 | Rep:Year), data=datw)
...
# test effect of w/wf trt -> StJean S, 600
model.UMwtws<- lmer(UM_wt ~ Weediness + ( 1 | Rep:Year), data=Sdatw2)
